...
author:
  - name: Evan Dragich
    affil: 1
    # orcid: '0000-0001-9751-1840'
  - name: Mine Çetinkaya-Rundel
    affil: 1
    # orcid: '0000-0002-6747-3289'
  - name: Matt Beckman
    affil: 2
  ...
  - name: Chelsey Legacy
    affil: 4
    # orcid: '0000-0002-6726-0590'
  - name: Maria Tackett
    affil: 1
    # orcid: '0000-0002-0254-3354'
  - name: Andy Zieffler
    affil: 4
...
affiliation:
  ...
  - num: 2
    address: Department of Statistics, The Pennsylvania State University
  - num: 3
    address: Department of Statistics, University of California, Irvine
  - num: 4
    address: Department of Educational Psychology, University of Minnesota, Twin Cities
  - num: 5
    address: Department of Statistical Science, University College London
column_numbers: 3
...
secondary_colour: "#7bbcd5"
primary_colour: "#0E1C36"
accent_colour: "#d2848d"
---
...
```{r, include=FALSE}
knitr::write_bib(c('knitr','rmarkdown','posterdown','pagedown'), 'references.bib')
```
