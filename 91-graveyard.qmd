...
2.  The bar chart shows the the percentage of docks in each city that were bike docks for each year from 2015--2020.
...
```
34. Consider the two following sets of pseudocode (ie. code recipe). Would they produce the same results? Explain.
