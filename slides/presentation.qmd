...
![](images/00-main-menu.png)

## Sample Tutorial: Code chunk with hint

![](images/03-hint.png)

## Sample Tutorial: Screenshot of code

-   take a screenshot of something that shows some good `gradethis` logic, possibly that exact code chunk from before
